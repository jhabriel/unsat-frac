...
for _, d in gb.edges(): mg = d["mortar_grid"]
...
full_flux_frac = (
    mpfa_frac.flux * frac_cell_rest * p
    + mpfa_frac.bound_flux * bound_frac
    )
...
interface_flux_eq = ( 
    robin.mortar_scaling * (pressure_trace_from_high - mortar_proj.secondary_to_mortar_avg * p)
