...
def test_arithmetic_2d():
    ...
    true_neu_arithmetic = np.array(
        [1, 65, 52, 1, 1, 6, 30, 1, 1, 1, 1, 16, 55, 27, 1, 1, 1,]
    )

    true_left_arithmetic = np.array(
        [21, 65, 52, 1, 5, 6, 30, 1, 1, 1, 1, 16, 55, 27, 1, 1, 1,]
    )

    true_right_arithmetic = np.array(
        [1, 65, 52, 8, 1, 6, 30, 29, 1, 1, 1, 16, 55, 27, 1, 1, 1,]
    )

    true_bottom_arithmetic = np.array(
        [1, 65, 52, 1, 1, 6, 30, 1, 19, 56, 5, 16, 55, 27, 1, 1, 1,]
    )

    true_top_arithmetic = np.array(
        [1, 65, 52, 1, 1, 6, 30, 1, 1, 1, 1, 16, 55, 27, 5, 11, 28,]
    )
...
def test_upwind_2d():
    ...
    true_neu_upwind = np.array(
        [1, 100, 100, 1, 1, 10, 50, 1, 1, 1, 1, 30, 100, 50, 1, 1, 1,]
    )

    true_left_upwind = np.array(
        [30, 100, 100, 1, 8, 10, 50, 1, 1, 1, 1, 30, 100, 50, 1, 1, 1,]
    )

    true_right_upwind = np.array(
        [1, 100, 100, 12, 1, 10, 50, 50, 1, 1, 1, 30, 100, 50, 1, 1, 1,]
    )

    true_bottom_upwind = np.array(
        [1, 100, 100, 1, 1, 10, 50, 1, 30, 100, 6, 30, 100, 50, 1, 1, 1,]
    )

    true_top_upwind = np.array(
        [1, 100, 100, 1, 1, 10, 50, 1, 1, 1, 1, 30, 100, 50, 8, 12, 50,]
    )
